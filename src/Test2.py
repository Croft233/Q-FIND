...
SingleSdFth(s1_count, s1_x, s1_topology_fidelity_mode, s1_nrof_requests, s1_alg1_mode, s1_link_capacity,
            s1_random_topology, s1_random_topology_mode, s1_random_topology_nodes_num)